...
namespace Shapes {
	...
	public abstract class ShapeRenderer : MonoBehaviour {
		...
		public int SortingLayerID {
			get => MakeSureComponentExists( ref rnd ).sortingLayerID;
			set => MakeSureComponentExists( ref rnd ).sortingLayerID = value;
		}
		public int SortingOrder {
			get => MakeSureComponentExists( ref rnd ).sortingOrder;
			set => MakeSureComponentExists( ref rnd ).sortingOrder = value;
		}
		...
		T MakeSureComponentExists<T>( ref T field ) where T : Component {
			if( field == null ) {

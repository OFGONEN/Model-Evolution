    ...
    public class AnimationHierarchyEditor : EditorWindow
    {
        ...
        private void OnGUI()
        {
			...
			if( animationClips.Count > 0 )
			{
				...
				animatorObject = ( ( Animator )EditorGUILayout.ObjectField( animatorObject,
                                                                            typeof( Animator ),
                                                                            true,
				...
				{
					animationClips[ 0 ] = ( ( AnimationClip )EditorGUILayout.ObjectField( animationClips[ 0 ],
		...
		private void GUICreatePathItem( string path )
		{
			...
			newObj = ( GameObject )EditorGUILayout.ObjectField( obj,
                                                                typeof( GameObject ),
                                                                true,
                                                                GUILayout.Width( columnWidth ) );
		...
		void ReplaceRoot( string oldRoot, string newRoot )
		{
			...
			for( int iCurrentClip = 0; iCurrentClip < animationClips.Count; iCurrentClip++ )
			{
				...
				for( int iCurrentPath = 0; iCurrentPath < pathsKeys.Count; iCurrentPath++ )
				{
					...
					EditorUtility.DisplayProgressBar( "Animation Hierarchy Progress",
